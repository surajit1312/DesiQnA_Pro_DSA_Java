...
### Problem: Given a sorted array of 0’s and 1’s find the first occurrence of 1 

    -> O(N) :- Start traveling the array initially and all zeroes will be there; as soon as you find a “1” coming :-> Break the algorithm and print its index. 
...
#### Links: 
    ...
    C++ https://ideone.com/9zeok2

    Java. https://ideone.com/C75fIR
